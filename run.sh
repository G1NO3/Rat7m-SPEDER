python main.py --alg spedersac --env kms --feature_dim 64 \
                --max_timesteps 1000000 --dir QR_keymoseq_filter_dataset_allznorm_bc_retrain4_nobatchnorm\
...
python visualize.py --alg spedersac --env kms --feature_dim 64 \
                --max_timesteps 700000 --dir QR_keymoseq_filter_dataset_allznorm_bc_retrain4_nobatchnorm --start_timesteps 20000\
