# python main.py --alg opal --env kms --feature_dim 64 \
#                  --max_timesteps 1000000 --dir A_f64_task78_lr1e-4_opal \
...
python visualize.py --alg opal --env kms --feature_dim 64 \
               --max_timesteps 1000000 --dir A_f64_task78_lr1e-4_opal --start_timesteps 200\
