python main.py --alg spedersac --env kms --feature_dim 128 \
                --max_timesteps 1000000 --dir N_f128_actor_autoregressive_actorclone_sac_partition \
...
#                 --max_timesteps 1000000 --dir N_f128_actor_autoregressive_actorclone_sac_2_only --start_timesteps 200\
