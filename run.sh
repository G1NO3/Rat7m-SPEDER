python main.py --alg spedersac --env kms --feature_dim 128 \
                --max_timesteps 1000000 --dir S_f128_datasets200a200_CD_Yilun_LD_step1e-1_task24 \
...
#                 --max_timesteps 1000000 --dir S_f128_datasets200a200_CD_Yilun_LD_step1e-1_task24 --start_timesteps 200\
