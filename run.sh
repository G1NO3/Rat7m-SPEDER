python main.py --alg iql --env kms --feature_dim 64 \
                 --max_timesteps 1000000 --dir A_f64_task78_lr1e-4_iql \
                 --eval_freq 1000 --discount 0.9 --batch_size 128 --lasso_coef 0.01 --feature_lr 0.0001 \
                 --actor_type gaussian
# # Caution
# python visualize.py --alg iql --env kms --feature_dim 64 \
#                --max_timesteps 1000000 --dir A_f64_task78_lr1e-3_iql --start_timesteps 200\
