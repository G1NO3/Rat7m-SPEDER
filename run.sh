...
#                 --max_timesteps 1000000 --dir S_f128_lasso_001_dataset200_discrete_fixf \
...
python visualize.py --alg spedersac --env kms --feature_dim 128 \
                --max_timesteps 600000 --dir S_f128_lasso_001_dataset200_discrete_fixf --start_timesteps 200\
