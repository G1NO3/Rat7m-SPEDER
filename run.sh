python main.py --alg spedersac --env kms --feature_dim 128 \
                --max_timesteps 1000000 --dir S_f128_datasets200a2_perturb \
...
#                 --max_timesteps 1000000 --dir S_f128_lasso_00_dataset200_CTRL_continuous_Norm1MLPuf_perturb --start_timesteps 200\
