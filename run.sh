...
#                 --max_timesteps 1000000 --dir dim64_sa_sp_buffer_20body_normalized_lr1e-4\
#                 --eval_freq 500 --discount 0.9 --batch_size 256

# python visualize.py --alg spedersac --env rat7m --feature_dim 64 \
#                 --max_timesteps 1000000 --dir dim64_sa_sp_buffer_20body_normalized_lr3e-4 --start_timesteps 20000\
#                 --eval_freq 500 --discount 0.9 --batch_size 128
for i in 64 96 128
do  
